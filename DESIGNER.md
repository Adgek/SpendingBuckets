...
5. **Write this in a file:** Put this output into a file in agent docs with a naming convention of DesignerNotes##.txt where the # signs are a running number of notes made.