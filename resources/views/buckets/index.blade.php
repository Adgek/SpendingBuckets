            ...
            ">
                ...
                @foreach ($fixedBuckets as $bucket)
                    ...
                    <div class="rounded-lg bg-elevated border border-border p-4 flex items-center gap-4 transition-shadow hover:shadow-lg"
                        ...
                        {{-- Priority Badge --}}
                        <div class="flex-shrink-0 w-8 h-8 rounded-full {{ $funded ? 'bg-forest' : 'bg-surface' }} flex items-center justify-center text-sm font-bold {{ $funded ? 'text-white' : 'text-muted' }}">
                            @if ($funded)
