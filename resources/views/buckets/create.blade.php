        ...
        <form method="POST" action="/buckets" class="space-y-4">
            ...
            <div>
                ...
                <select name="type" id="type" required
                    ...
                    <option value="excess" {{ old('type') === 'excess' ? 'selected' : '' }}>Excess</option>
                </select>
            ...
            <div>
                <label for="excess_percentage" class="block text-sm font-medium text-gray-700">Excess Percentage (for excess buckets)</label>
